...
class TestDatabaseManager:
    ...
    async def setup(self):
        ...
        if self._setup_complete:
            await self.cleanup()  # Ensure cleanup before re-setup
    ...
    async def clear_all_data(self):
        """Clear all data from database without dropping tables"""
...
async def setup_test_environment():
    ...
    await test_db.setup()  # This will ensure fresh tables for each test
    yield
    await test_db.cleanup()  # Complete cleanup after each test
