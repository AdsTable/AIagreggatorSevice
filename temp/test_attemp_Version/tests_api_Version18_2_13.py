...
class TestDatabaseManager:
    ...
    async def setup_for_class(self, class_name):
        ...
        # Для SQLite in-memory базы, убедимся, что мы используем правильный формат URL
        # Для каждого класса тестов создается отдельное соединение с уникальным именем
