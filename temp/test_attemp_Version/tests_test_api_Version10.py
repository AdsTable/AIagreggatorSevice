...
# --- Session Management ---
class TestSession:
    """Test session wrapper that provides both direct access and FastAPI dependency compatibility."""
    ...
    async def create_session(self):
        """Create a new session with transaction."""
    ...
    # Session methods - delegation pattern
...
async def setup_database():
    ...
    await test_session.setup()
    yield
    await test_session.close_engine()

@pytest.fixture
async def session():
    """Create session for tests with transaction isolation."""
    test_session = TestSession()
    await test_session.create_session()
    try:
        yield test_session
    finally:
...
async def client(session):
    ...
    # Override dependency with our test session
...
# --- Database Tests ---
@pytest.mark.asyncio
async def test_session_fixture_works(session: TestSession):
...
@pytest.mark.asyncio
async def test_store_standardized_data(session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_and_filter_products(session: TestSession, test_products: List[StandardizedProduct]):
...
# --- API Endpoint Tests ---
@pytest.mark.asyncio
async def test_search_endpoint_no_filters(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_filter_by_type(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_filter_by_min_price(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_filter_by_provider(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_filter_by_max_data_gb(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_filter_by_min_contract_duration(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_combined_filters(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_no_results(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
...
@pytest.mark.asyncio
async def test_search_endpoint_all_filters(client: AsyncClient, session: TestSession, test_products: List[StandardizedProduct]):
