...
class TestAPI:
    ...
    def test_search_endpoint_no_filters(self, api_client, test_products):
        """Test search endpoint without filters"""
        # Setup data first
        session = test_db.session_factory()  # Use synchronous session
        try:
    ...
    def test_search_endpoint_with_filters(self, api_client, test_products):
...
class TestAPIErrors:
    ...
    def test_api_with_database_error(self, api_client):
